...
class AppUserRegistrationType  extends AbstractType
{

    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
            ->add('appUserInfo', AppUserInfoRegistrationType::class,[
            'label' => false,
            'required' => true
            ])
            ->add('trnVolunterDetail', TrnVolunterDetailRegistrationType::class,[
                'label' => false,
                'required' => true
            ])
            ...
            ->add('trnOrganizationDetails', CollectionType::class, [
                'entry_type' => TrnOrganizationDetailsType::class,
//                'required' => false,
                'label' => false,
                'entry_options' => [
                    'label' => false,
