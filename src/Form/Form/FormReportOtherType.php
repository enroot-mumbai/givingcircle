...
class FormReportOtherType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('otherFirstName', TextType::class,[
                'label' =>false,
                'required' => false,
                'constraints' => [
                    new NotBlank(),
            ...
            ->add('otherLastName', TextType::class,[
                'label' =>false,
                'required' => false,
                'constraints' => [
                    new NotBlank(),
            ...
            ->add('otherEmailAddress', EmailType::class,[
                'label' =>false,
                'required' => false,
                'constraints' => [
                    new NotBlank(),
            ...
            ->add('otherMobileNumber', TelType::class,[
                'label' =>false,
                'required' => false,
                'attr' => [
                    'minlength' => '10',
            ...
            ->add('mstCityOther', EntityType::class,[
                'class' => MstCity::class,
                'label' =>false,
                'required' => false,
                'constraints' => [
...
//            ->add('yourInspire', TextareaType::class,[
//                'label' =>false,
//                'required' => true,
//                'constraints' => [
//                    new NotBlank(),
...
//                ]
//            ])
//            ->add('otherInspire', TextareaType::class,[
//                'label' =>false,
//                'required' => true,
//                'constraints' => [
//                    new NotBlank(),
