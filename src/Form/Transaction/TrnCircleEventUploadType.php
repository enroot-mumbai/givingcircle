...
class TrnCircleEventUploadType extends AbstractType
{
    ...
    {
        $builder
            ->add('trnCircleEventUploadedDocuments', CollectionType::class, [
                'entry_type' => TrnCircleEventUploadedDocumentsType::class,
                'required' => false,
                'label' => false,
                'entry_options' => [
                    'label' => false,
