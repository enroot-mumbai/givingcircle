...
class TrnCircleEventRecurringDetailsType extends AbstractType
{
    ...
    {
        $builder
            ->add('mstRecurringBy', EntityType::class,[
                'label' => 'label.recurring_by',
                'class' => MstRecurringBy::class,
                'placeholder' => 'placeholder.form.select',
                'required' => false
            ])
            ->add('numberOfDays', NumberType::class,[
                'label' => 'label.number_of_days',
                'required' => true,
            ])
            ->add('mstDaysOfWeek', EntityType::class,[
                'label' => 'label.days_of_the_week',
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => TrnCircleEventRecurringDetails::class,
        ]);
    }
}
