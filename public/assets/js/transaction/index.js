$(document).ready(function () {
    ...
    jQuery("#trn_collection_centre_details_mstCountry").change(function () {
        var data = {};
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                var product = $("#trn_collection_centre_details_mstState");
                product.html('');
                // add options
    ...
    jQuery("#trn_collection_centre_details_mstState").change(function () {
        var data = {};
        data['q'] = jQuery(this).val();
        jQuery.ajax({
            ...
            dataType: "JSON",
            success: function (data) {
                var product = $("#trn_collection_centre_details_mstCity");
                product.html('');
                // add options
