$(document).ready(function () {
    ...
    $('[name="liSkillSet"]').click(function (){
        var skillSetId = $(this).attr('skillsetid');
        if($("#anchSkillSet_"+skillSetId).hasClass('active')) {
            $("#skillSet_"+skillSetId).prop('checked', false);
        } else {
            $("#skillSet_"+skillSetId).prop('checked', true);
        }
        $("#anchSkillSet_"+skillSetId).toggleClass('active');
    });
...
function valid() {
    if($('[name="skillSet[]"]:checked').length == 0) {
