$(document).ready(function () {
    ...
    $("#totalEvents").html("Total Events ("+totalEvents+")");
    ...
    $(document).on('click', '.checkBoxNameMember', function (e) {
        url = updateIsTrendingUrl.replace('xyz', $(this).val());
        var data = {};
