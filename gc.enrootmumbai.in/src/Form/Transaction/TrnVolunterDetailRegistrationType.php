...
class TrnVolunterDetailRegistrationType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('hasDisability', CheckboxType::class,[
                'label' => 'Do you consider yourself a person with a disability?',
                'required' => false,
                'attr' => [
            ...
            ->add('isWillingToHelpInDisaster', CheckboxType::class,[
                'label' => 'Do you want to help in disaster?',
                'required' => false,
                'attr' => [
                    'checked' => 'checked'
                ]
