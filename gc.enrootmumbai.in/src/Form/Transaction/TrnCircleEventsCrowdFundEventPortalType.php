...
class TrnCircleEventsCrowdFundEventPortalType extends AbstractType
{
    /**
...
//                    'min' => date('Y-m-d'),
            ...
            ->add('trnCrowdFundEvents', CollectionType::class, [
                'entry_type' => TrnCrowdFundEventPortalType::class,
                'required' => false,
                'label' => false,
                'entry_options' => [
                    'label' => false,
