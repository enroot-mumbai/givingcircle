...
/**
 * @Route("/core/cms/volunteerdiariescomment", name="cms_volunteer_diaries_comment_")
 * @IsGranted("ROLE_SYS_CONTENT_USER")
 */
class CmsArticleVolunteerDiariesCommentController extends AbstractController
{
    /**
    ...
    {
        $article_id = $request->query->get('vltdiary_id');
        if(!$article_id) {
        ...
        return $this->render('cms/cms_article_comment/index.html.twig', [
            ...
            'article' => $article,
            'path_index' => 'cms_volunteer_diaries_comment_index',
            'path_add' => 'cms_volunteer_diaries_comment_add',
            'path_edit' => 'cms_volunteer_diaries_comment_edit',
            'path_show' => 'cms_volunteer_diaries_comment_show',
            'label_title' => 'label.comment',
            'label_heading' => 'label.volunteer_diaries'
        ]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('cms_volunteer_diaries_comment_index', $request->query->all());
        }
        ...
        return $this->render('cms/cms_article_comment/form.html.twig', [
            ...
            'index_path' => 'cms_volunteer_diaries_comment_index',
            'label_title' => 'label.comment',
